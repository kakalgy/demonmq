...
public class MessageId implements DataStructure, Comparable<MessageId> {
    ...
    */
    ...
    /**
     * @return a locator which aids a message store in loading a message faster.
     *         Only used by the message stores.
     */
    ...
    /**
     * Sets a locator which aids a message store in loading a message faster. Only
     * used by the message stores.
     */
