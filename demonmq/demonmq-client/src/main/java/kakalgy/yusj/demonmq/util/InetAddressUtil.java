...
public class InetAddressUtil {
     ...
     * entry exists for a given host, the following exception will be thrown: <code>
     * java.net.UnknownHostException: &lt;hostname&gt;: &lt;hostname&gt;
     *  at java.net.InetAddress.getLocalHost(InetAddress.java:1425)
     *   ...
     * </code> Instead of just throwing an UnknownHostException and giving up, this
     * method grabs a suitable hostname from the exception and prevents the
     * exception from being thrown. If a suitable hostname cannot be acquired from
     * the exception, only then is the <tt>UnknownHostException</tt> thrown.
     * 
     * @return The hostname
