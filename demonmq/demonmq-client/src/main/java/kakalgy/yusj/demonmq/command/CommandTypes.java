...
public interface CommandTypes {
    ...
    byte DEMONMQ_MESSAGE = 23;
    byte DEMONMQ_BYTES_MESSAGE = 24;
    byte DEMONMQ_MAP_MESSAGE = 25;
    byte DEMONMQ_OBJECT_MESSAGE = 26;
    byte DEMONMQ_STREAM_MESSAGE = 27;
    byte DEMONMQ_TEXT_MESSAGE = 28;
    byte DEMONMQ_BLOB_MESSAGE = 29;
    ...
    // /////////////////////////////////////////////////
    //
    // Reliability(可靠性) and fragmentation(分片)
    //
    // /////////////////////////////////////////////////
    ...
    //
    // /////////////////////////////////////////////////
    byte DEMONMQ_QUEUE = 100;
    byte DEMONMQ_TOPIC = 101;
    byte DEMONMQ_TEMP_QUEUE = 102;
    byte DEMONMQ_TEMP_TOPIC = 103;

    byte MESSAGE_ID = 110;
    byte DEMONMQ_LOCAL_TRANSACTION_ID = 111;
    byte DEMONMQ_XA_TRANSACTION_ID = 112;
