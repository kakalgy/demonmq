...
public class JNDIReferenceFactory implements ObjectFactory {
	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable<?, ?> environment) throws Exception {
		...
		if (obj instanceof Reference) {
			...
			if (logger.isTraceEnabled()) {
				logger.trace("JNDIReferenceFactory.getObjectInstance : Getting instance of " + reference.getClassName());
			}
			...
			logger.error("Object " + obj + " is not a reference - cannot load");
	...
	public static Reference createReference(String instanceClassName, JNDIStorableInterface po) throws NamingException {
		if (logger.isTraceEnabled()) {
			logger.trace("Creating reference [instanceClassName : " + instanceClassName + ", JNDIStorableInterface: " + po + "]");
		}
